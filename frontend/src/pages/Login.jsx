  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 grid place-items-center p-6">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-6 shadow-xl">
        ...
        <p className="text-sm text-slate-300 mt-1">Access your Exam Command Centre.</p>
        ...
        <div className="mt-5 space-y-3">
          ...
          <button
            ...
            onClick={async () => {
              try { setErr(""); await login(email, password); onAuthed?.(); }
          ...
          <Link to="/signup" className="block text-sm text-slate-300 hover:text-slate-100 transition text-center">
